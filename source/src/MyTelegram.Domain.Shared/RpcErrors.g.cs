...
public class RpcErrors
{
    ...
    public static class RpcErrors400
    {
       ...
       /// </code>
       /// </summary>
       public static readonly RpcError ImportHistoryLogEmpty = new(ErrorCode, "IMPORT_HISTORY_LOG_EMPTY");
       ...
       /// <summary>
       /// A [takeout](https://core.telegram.org/api/takeout) session needs to be initialized first, [see here  for more info](/api/takeout).
       /// <code>
       /// contacts.getSaved
       /// </code>
       /// </summary>
       ...
       /// </code>
       /// </summary>
       public static readonly RpcError BotPollsDisabled = new(ErrorCode, "BOT_POLLS_DISABLED");
       ...
       /// </code>
       /// </summary>
       public static readonly RpcError GroupCallInvalid = new(ErrorCode, "GROUP_CALL_INVALID");
       ...
       /// </code>
       /// </summary>
       public static readonly RpcError PhotoThumbUrlInvalid = new(ErrorCode, "PHOTO_THUMB_URL_INVALID");
    ...
    public static class RpcErrors401
    {
       ...
       /// 
       /// </summary>
       public static readonly RpcError ActiveUserRequired = new(ErrorCode, "ACTIVE_USER_REQUIRED");
    ...
    public static class RpcErrors420
    {
       ...
       /// </code>
       /// </summary>
       public static readonly RpcError FloodTestPhoneWaitX = new(ErrorCode, "FLOOD_TEST_PHONE_WAIT_{0}");
    ...
    public static class RpcErrors500
    {
       ...
       /// </code>
       /// </summary>
       public static readonly RpcError CdnSaltsEmpty = new(ErrorCode, "CDN_SALTS_EMPTY");
