...
//        }
//        _logger.LogDebug("In-memory events count:{Count},removed count:{RemovedCount},identity type:{IdentityType}", _eventStore.Count, committedDomainEvents?.Count, id.GetType().Name);
