...
public class GetDeviceByUidQueryHandler(IQueryOnlyReadModelStore<DeviceReadModel> store) : IQueryHandler<GetDeviceByUserIdQuery, IReadOnlyCollection<IDeviceReadModel>>
{
